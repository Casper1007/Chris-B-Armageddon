...
output "chewbacca_alb_dns_name01" {
  description = "DNS name of the load balancer"
  value       = aws_lb.chewbacca_alb01.dns_name
}

output "chewbacca_alb_arn01" {
  description = "ARN of the load balancer"
  value       = aws_lb.chewbacca_alb01.arn
}

output "chewbacca_target_group_arn01" {
  description = "ARN of the target group"
  value       = aws_lb_target_group.chewbacca_tg01.arn
}

output "chewbacca_http_listener_arn01" {
  description = "ARN of HTTP listener"
  value       = aws_lb_listener.chewbacca_http_listener01.arn
}
